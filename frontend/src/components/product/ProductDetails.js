                  ...
                  <Box className="priceSec">
                    ...
                    <Typography variant="h5" sx={{ fontWeight: "bolder" }}>
                      {data.selling_price &&
                        (
                          data.selling_price -
                          (data.selling_price / 100) * (data.categories.discount_limit && data.categories[0].discount_limit > 0  ? data.discount_limit < data.categories[0].discount_limit ? data.discount_limit : data.categories[0].discount_limit : data.discount_limit )
